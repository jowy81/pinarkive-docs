---
title: PinArkive Upload Playground — Drag-and-Drop Demo
description: "Try the PinArkive Upload Playground: drag-and-drop file uploads, get CID and gateway URL. Reference for building your own upload UI."
---
...
- [POST /files](/api-reference/post-files) — API reference
