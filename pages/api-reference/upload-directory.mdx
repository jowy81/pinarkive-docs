---
title: POST /files/directory — Upload Directory or DAG (PinArkive)
description: "Upload a directory (server path) or multiple files as a DAG via POST /files/directory and /files/directory-dag. Optional cluster and timelock. Scope files:write."
---
