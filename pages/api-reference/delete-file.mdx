---
title: DELETE /files/remove/:cid — Remove Pin (PinArkive)
description: "Remove a pin by CID with DELETE /files/remove/:cid. Scope files:delete. Uses stored clusterId. cURL, fetch, axios, Python, Go, PHP examples."
---
