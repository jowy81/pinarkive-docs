---
title: PinArkive CLI Commands Reference — Upload, Pin, Share
description: "Full reference for PinArkive CLI: upload, pin, files, delete, clusters, gateway, share, watch, whoami, doctor, init. Auth and API endpoints used."
---
