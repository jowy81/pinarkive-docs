---
title: PinArkive API Keys (Tokens) — Create, Revoke & Scopes
description: "Create and revoke API keys (tokens) via dashboard or POST /tokens/generate. Scopes: files:read, files:write, files:delete, cluster:read. 2FA support."
---
