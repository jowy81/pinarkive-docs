---
title: PinArkive Timelocks — Time-Limited Pins & Expiration
description: "Set expiration for pins with timelock (ISO 8601). Premium feature: temporary sharing, demos, retention policies. Example response with expiresAt."
---
...
See [POST /files](/api-reference/post-files) and [POST /pin](/api-reference/post-pin) to set timelocks.
