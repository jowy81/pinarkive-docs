...
For cluster-specific gateways, use the URLs returned by [GET /users/me/clusters](/api/get-clusters).
...
- [POST /files](/api/post-files) — Full upload reference with examples in JavaScript, Python, Go, PHP
