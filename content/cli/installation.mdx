...
Create an API key in the [Pinarkive dashboard](https://pinarkive.com) or via `POST https://api.pinarkive.com/v3/tokens/generate` with scopes `files:read`, `files:write`, `files:delete`, and `cluster:read` as needed.
